...
module FactoryBot::Internal
  def self.after(*, **, &); end
  def self.before(*, **, &); end
  def self.build_uri(*, **, &); end
  def self.callbacks(*, **, &); end
  def self.configuration; end
  def self.constructor(*, **, &); end
  def self.factories(*, **, &); end
  def self.factory_by_name(name); end
  def self.fail_argument_count(received, expected); end
  def self.fail_unregistered_sequence(uri); end
  ...
  def self.rewind_sequence(*uri_parts); end
  def self.rewind_sequences; end
  def self.sequence_by_name(name); end
  def self.sequences(*, **, &); end
  def self.set_sequence(*uri_parts, value); end
...
module FactoryBot::Strategy
  def self.lookup_strategy(name_or_object); end
end
...
class FactoryBot::Evaluator
  ...
  def attribute_lists?; end
  def increment_sequence(sequence, scope: nil); end
  ...
  def self.__class_attr_attribute_lists; end
  def self.__class_attr_attribute_lists=(new_value); end
...
class FactoryBot::Sequence
  ...
  def self.find(*uri_parts); end
  def self.find_by_uri(uri); end
...
class FactoryBot::Definition
  ...
  def initialize(name, base_traits = nil, **opts); end
  def initialize_copy(source); end
  def klass; end
  def klass=(arg0); end
  def name; end
...
module FactoryBot::Syntax::Methods
  ...
  def generate(*uri_parts, scope: nil); end
  def generate_list(*uri_parts, count, scope: nil); end
  def increment_sequence(sequence, scope: nil); end
...
class FactoryBot::UriManager
  ...
  def first(*, **, &); end
  def include?(*, **, &); end
  def initialize(*endpoints, paths: nil); end
  def paths; end
  def self.build_uri(*parts); end
  def size(*, **, &); end
  def to_a; end
  def uri_list; end
end

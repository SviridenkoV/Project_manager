...
module ActiveSupport
  ...
  def self.escape_js_separators_in_json(*, **, &); end
  def self.escape_js_separators_in_json=(arg); end
  def self.event_reporter; end
  def self.event_reporter=(arg0); end
  def self.filter_parameters; end
  def self.filter_parameters=(val); end
  def self.gem_version; end
  def self.json_encoder(*, **, &); end
  def self.json_encoder=(arg); end
  def self.parallelize_test_databases; end
  def self.parallelize_test_databases=(val); end
...
class ActiveSupport::TagStack
  def self.resolve_tags(args, kwargs); end
  def self.tags; end
  def self.with_tags(*args, **kwargs); end
end
class ActiveSupport::EventContext
  def self.clear; end
  def self.context; end
  def self.set_context(context_hash); end
end
class ActiveSupport::EventReporter
  def clear_context; end
  def context; end
  def context_store; end
  def debug(name_or_object, payload = nil, caller_depth: nil, **kwargs); end
  def debug_mode=(arg0); end
  def debug_mode?; end
  def handle_unexpected_args(name_or_object, payload, kwargs); end
  def initialize(*subscribers, raise_on_error: nil); end
  def notify(name_or_object, payload = nil, caller_depth: nil, **kwargs); end
  ...
  def self.context_store; end
  def self.context_store=(arg0); end
...
module ActiveSupport::JSON
  ...
  def self.load(json, options = nil); end
...
module ActiveSupport::JSON::Encoding
  def self.encode_without_escape(value); end
  def self.encode_without_options(value); end
  def self.escape_html_entities_in_json; end
  def self.escape_html_entities_in_json=(arg0); end
  def self.escape_js_separators_in_json; end
  def self.escape_js_separators_in_json=(arg0); end
  def self.json_encoder; end
  def self.json_encoder=(encoder); end
  def self.time_precision; end
...
class ActiveSupport::HashWithIndifferentAccess < Hash
  ...
  def slice!(*keys); end
  def slice(*keys); end
  def store(key, value, convert_value: nil); end
  def symbolize_keys; end
  def to_hash; end
  def to_options!; end
  def to_options; end
...
class ActiveSupport::BacktraceCleaner
  ...
  def clean_locations(locations, kind = nil); end
  def filter(backtrace, kind = nil); end
  def filter_backtrace(backtrace); end
  def first_clean_frame(kind = nil); end
  def first_clean_location(kind = nil); end
  def initialize; end
...
class ActiveSupport::StructuredEventSubscriber < ActiveSupport::Subscriber
  def call(event); end
  def emit_debug_event(name, payload = nil, caller_depth: nil, **kwargs); end
  def emit_event(name, payload = nil, caller_depth: nil, **kwargs); end
  def handle_event_error(name, error); end
  def initialize; end
  def self.__class_attr_debug_methods; end
  def self.__class_attr_debug_methods=(new_value); end
  def self.attach_to(*, **, &); end
  def self.debug_methods; end
  def self.debug_methods=(value); end
  def self.debug_methods?; end
  def self.debug_only(method); end
  def self.set_silenced_events; end
  def silenced?(event); end
  def silenced_events=(arg0); end
end
...
class ActiveSupport::Cache::Store
  ...
  def expand_and_namespace_key(key, options = nil); end
...
module ActiveSupport::ExecutionContext
  ...
  def self.clear; end
  def self.current_attributes_instances; end
  def self.flush; end
  def self.nestable; end
  def self.nestable=(arg0); end
  def self.pop; end
  def self.push; end
  def self.record; end
...
module ActiveSupport::IsolatedExecutionState
  ...
  def self.scope; end
  def self.share_with(other, except: nil, &block); end
end
class Thread
...
module ActiveSupport::Concurrency::LoadInterlockAwareMonitor
end
...
module ActiveSupport::Testing::ErrorReporterAssertions
  ...
  def capture_error_reports(error_class = nil, &block); end
end
...
module ActiveSupport::Testing::EventReporterAssertions
  def assert_event_reported(name, payload: nil, tags: nil, &block); end
  def assert_events_reported(expected_events, &block); end
  def assert_no_event_reported(name = nil, payload: nil, tags: nil, &block); end
  def with_debug_event_reporting(&block); end
end
module ActiveSupport::Testing::EventReporterAssertions::EventCollector
  def self.emit(event); end
  def self.event_recorders; end
  def self.record; end
  def self.subscribe; end
end
...
module ActiveSupport::Testing::TimeHelpers
  def after_teardown; end
  def freeze_time(date_or_time = nil, with_usec: nil, &block); end
  def in_block; end
...
class ActiveSupport::Testing::Parallelization
  ...
  def self.before_fork_hook(&blk); end
  def self.before_fork_hooks; end
...
module ActiveSupport::Testing::NotificationAssertions
  def assert_no_notifications(pattern = nil, &block); end
  def assert_notification(pattern, payload = nil, &block); end
  def assert_notifications_count(pattern, count, &block); end
  def capture_notifications(pattern = nil, &block); end
end
...
class ActiveSupport::TestCase < Minitest::Test
  ...
  def assert_not_includes(obj, sub, msg = nil); end

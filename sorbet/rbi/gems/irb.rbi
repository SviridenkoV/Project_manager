...
class IRB::RubyLex
  ...
  def check_syntax_error_heuristics(prism_parse_result); end
  def check_termination_in_prev_line(code, local_variables:); end
  def code_terminated?(code, continue, opens, local_variables:); end
  ...
  def should_continue?(tokens, line, line_num); end
end
...
module IRB::Color
  ...
  def self.filter_incomplete_code_errors(errors, tokens); end
  def self.inspect_colorable?(obj, seen: nil); end
  def self.without_circular_ref(obj, seen:, &block); end
end
class InvalidName___Class_0x00___ColorizeVisitor_50 < Prism::Visitor
  def dispatch(location, type); end
  def dispatch_alias_method_name(node); end
  def initialize; end
  def tokens; end
...
class IRB::CommandDocument < IRB::DocumentTarget
end
class IRB::MethodDocument < IRB::DocumentTarget
end
...
module InvalidName___Class_0x00___SkipPathHelperForIRB_51
end

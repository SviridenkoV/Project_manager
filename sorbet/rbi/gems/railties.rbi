...
class Rails::Initializable::Initializer
  ...
  def initialize(name, context, before:, after:, group: nil, &block); end
  def name; end
  def run(*args); end
end
class Rails::Initializable::Collection
  ...
  def each(&block); end
  def has?(name); end
  def initialize(initializers = nil); end
  def last; end
...
module Rails::LineFiltering::MT6
  def run_suite(reporter, options = nil); end
end
...
class Rails::Application::Configuration < Rails::Engine::Configuration
  ...
  def content_security_policy_nonce_auto=(arg0); end
...
class Rails::CodeStatisticsCalculator
  ...
  def initialize(lines = nil, code_lines = nil, classes = nil, methods = nil); end
  def lines; end
  def methods; end
end
class Rails::CodeStatistics
  def calculate_code; end
  def calculate_directory_statistics(directory, pattern = nil); end
  ...
  def self.__class_attr_directories; end
  def self.__class_attr_directories=(new_value); end
  def self.__class_attr_pattern; end
  def self.__class_attr_pattern=(new_value); end
  def self.__class_attr_test_types; end
  def self.__class_attr_test_types=(new_value); end
  def self.directories; end
  def self.directories=(value); end
  def self.directories?; end
  def self.pattern; end
  def self.pattern=(value); end
  def self.pattern?; end
  def self.register_directory(label, path, test_directory: nil); end
  def self.test_types; end
  def self.test_types=(value); end
  def self.test_types?; end
  def test_types; end
  def test_types=(arg0); end
  def test_types?; end
  def to_s; end

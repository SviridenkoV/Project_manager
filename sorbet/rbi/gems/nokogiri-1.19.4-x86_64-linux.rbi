...
#
#   https://github.com/sorbet/sorbet-typed/new/master?filename=lib/nokogiri-1.19.4-x86_64-linux/all/nokogiri-1.19.4-x86_64-linux.rbi
#
...
class Nokogiri::XML::Node
  ...
  def delete(name); end
  def description; end
  def do_xinclude(options = nil, safe_copy: nil); end
  def document; end
  def document?; end
  def dump_html; end
  ...
  def safe_process_xinclude(arg0); end
  def self.new(*arg0); end

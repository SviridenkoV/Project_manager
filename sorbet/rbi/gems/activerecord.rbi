...
module Arel::Crud
  def compile_delete(key = nil); end
  def compile_insert(values); end
  def compile_update(values, key = nil); end
...
class Arel::Nodes::Count < Arel::Nodes::Function
  def initialize(expr, distinct = nil); end
end
...
module ActiveRecord
  ...
  def self.default_transaction_isolation_level; end
  def self.default_transaction_isolation_level=(isolation_level); end
  def self.deprecated_associations_options; end
  def self.deprecated_associations_options=(options); end
  ...
  def self.message_verifiers; end
  def self.message_verifiers=(arg0); end
  ...
  def self.raise_on_missing_required_finder_order_columns; end
  def self.raise_on_missing_required_finder_order_columns=(arg0); end
  ...
  def self.schema_versions_formatter; end
  def self.schema_versions_formatter=(arg0); end
  ...
  def self.with_transaction_isolation_level(isolation_level, &block); end
...
class ActiveRecord::DeprecatedAssociationError < ActiveRecord::ActiveRecordError
end
...
class ActiveRecord::CheckViolation < ActiveRecord::StatementInvalid
end
class ActiveRecord::ExclusionViolation < ActiveRecord::StatementInvalid
end
...
class ActiveRecord::MissingRequiredOrderError < ActiveRecord::ActiveRecordError
end
...
module ActiveRecord::RuntimeRegistry
  ...
  def record(query_name, runtime, cached: nil, async: nil, lock_wait: nil); end
  def reset; end
  def stats; end
...
class ActiveRecord::RuntimeRegistry::Stats
  ...
  def async_sql_runtime=(arg0); end
  def cached_queries_count; end
  def cached_queries_count=(arg0); end
  def initialize; end
  def queries_count; end
  def queries_count=(arg0); end
  def reset; end
...
class ActiveRecord::ConnectionAdapters::ConnectionPool
  ...
  def inspect; end
  def internal_metadata; end
  def keep_alive(threshold = nil); end
  def keepalive; end
  ...
  def retire_old_connections(max_age = nil); end
...
class ActiveRecord::FilterAttributeHandler
  ...
  def self.on_sensitive_attribute_declared(&block); end
  def self.sensitive_attribute_was_declared(klass, list); end
end
...
module ActiveRecord::Associations::Deprecation
  ...
  def self.backtrace=(value); end
  def self.backtrace_cleaner; end
  def self.clean_frames; end
  def self.clean_locations; end
  def self.guard(reflection); end
  def self.mode; end
  def self.mode=(value); end
  def self.report(reflection, context:); end
  def self.set_backtrace_supports_array_of_locations?; end
  def self.user_facing_reflection(reflection); end
end
...
class ActiveRecord::DynamicMatchers::Method
  def self.attribute_names(model, name); end
  def self.attributes_hash(model, method_name); end
  def self.body(model, method_name); end
  def self.define(model, name); end
  def self.make_pattern(prefix, suffix); end
  def self.match(name); end
  def self.signature(model, method_name); end
  def self.valid?(model, name); end
end
...
class ActiveRecord::ExplainRegistry::Subscriber
  ...
  def self.ensure_subscribed; end
...
class ActiveRecord::Type::Serialized < Anonymous_Delegator_23
  ...
  def initialize(subtype, coder, comparable: nil); end
  def inspect; end
...
module ActiveRecord::Enum
  ...
  def raise_conflict_error(enum_name, method_name, type, source: nil); end
...
module ActiveRecord::Persistence
  ...
  def update_attribute(name, value); end
  def update_column(name, value, touch: nil); end
...
module ActiveRecord::AttributeMethods::Serialization::ClassMethods
  ...
  def serialize(attr_name, coder: nil, type: nil, comparable: nil, yaml: nil, **options); end
...
class ActiveRecord::Store::HashAccessor
  def self.get(store_object, key); end
...
module ActiveRecord::SignedId::ClassMethods
  ...
  def find_signed!(signed_id, purpose: nil, on_rotation: nil); end
  def find_signed(signed_id, purpose: nil, on_rotation: nil); end
...
module ActiveRecord::ConnectionAdapters::DatabaseStatements
  ...
  def query(sql, name = nil, allow_retry: nil, materialize_transactions: nil); end
  def query_value(*, **, &); end
...
module ActiveRecord::ConnectionAdapters::SchemaStatements
  ...
  def index_exists?(table_name, column_name = nil, **options); end
...
class ActiveRecord::ConnectionAdapters::AbstractAdapter
  ...
  def exec_query(*, **, &); end
  def execute(*, **, &); end
  def expire(update_idle = nil); end
  ...
  def log(sql, name = nil, binds = nil, type_casted_binds = nil, async: nil, allow_retry: nil, &block); end
  def logger; end
  def max_jitter; end
  def native_database_types; end
  def owner; end
...
class ActiveRecord::ConnectionAdapters::Column
  ...
  def human_name; end
  def init_with(coder); end
  def initialize(name, cast_type, default, sql_type_metadata = nil, null = nil, default_function = nil, collation: nil, comment: nil, **); end
  def limit(*, **, &); end
  def name; end
  def null; end
  def precision(*, **, &); end
...
class ActiveRecord::ConnectionAdapters::Table
  ...
  def index(column_name, **options); end
  def index_exists?(column_name = nil, **options); end
...
class ActiveRecord::ConnectionAdapters::SQLite3::SchemaDumper < ActiveRecord::ConnectionAdapters::SchemaDumper
  ...
  def prepare_column_options(column); end
  def primary_key_has_autoincrement?; end
  def virtual_tables(stream); end
end
...
class ActiveRecord::Base
  ...
  def self.__class_attr__signed_id_verifier; end
  def self.__class_attr__signed_id_verifier=(new_value); end
  ...
  def self._signed_id_verifier; end
  def self._signed_id_verifier=(value); end
  ...
  def self.signed_id_verifier_secret=(secret); end
  def self.signed_id_verifier_secret?; end
...
class ActiveRecord::Migration::Compatibility::V7_2 < ActiveRecord::Migration::Compatibility::V8_0
end

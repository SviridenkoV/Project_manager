...
class Jbuilder < BasicObject
  def _array(collection = nil, attributes = nil, &block); end
  ...
  def _scope; end
  def _set(key, value = nil, attributes = nil, &block); end
...
class JbuilderTemplate < Jbuilder
  ...
  def array!(collection = nil, *args, &block); end

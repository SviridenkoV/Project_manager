...
class Devise::Controllers::Responder < ActionController::Responder
  def self.__class_attr_error_status; end
  def self.__class_attr_error_status=(new_value); end
  def self.__class_attr_redirect_status; end
  def self.__class_attr_redirect_status=(new_value); end
end
...
class Devise::SessionsController < DeviseController
  ...
  def destroy; end
  def new; end
  def respond_to_on_destroy(non_navigational_status: nil); end
  def self.__class_attr___callbacks; end
  def self.__class_attr___callbacks=(new_value); end
  def self.__class_attr__wrapper_options; end
  def self.__class_attr__wrapper_options=(new_value); end

...
class InvalidName___Class_0x00___Differ_55
end
...
class RSpec::Matchers::BuiltIn::Exist::ExistenceTest < Anonymous_Struct_56
end
...
class RSpec::Matchers::BuiltIn::CaptureStreamToTempfile < Anonymous_Struct_57
end

...
class Turbo::ThreadDebouncer
  ...
  def debouncer_class=(arg0); end
  def debouncer_class?; end
  def initialize(key, thread, delay:); end
  def key; end
  def self.__class_attr_debouncer_class; end
  def self.__class_attr_debouncer_class=(new_value); end
  def self.debouncer_class; end
  def self.debouncer_class=(value); end
  def self.debouncer_class?; end
...
module Turbo::TestAssertions
  ...
  def assert_turbo_frame(*ids, loading: nil, src: nil, target: nil, count: nil, &block); end

...
class Faker::DrivingLicence < Faker::Base
  ...
  def self.uk_driving_licence(*); end
...
class InvalidName___Class_0x00___UnavailableInEra_47 < StandardError
end
...
module Faker::Config
  ...
  def self.lazy_loading=(value); end
  def self.lazy_loading?; end
  def self.locale; end
...
class Faker::Base
  ...
  def self.generate(as_type, &); end
  def self.letterify(letter_string); end
  def self.method_missing(mth, *args, &); end

...
module Bootsnap
  ...
  def self.enable_frozen_string_literal(app_only: nil); end
  def self.enabled?(key); end
  def self.instrumentation=(callback); end
  def self.instrumentation_enabled=(arg0); end
  def self.load_config(config_path); end
  def self.log!; end
  def self.log_stats!; end
  def self.logger; end
  def self.logger=(logger); end
  def self.rb_get_path(arg0); end
  def self.setup(cache_dir:, development_mode: nil, load_path_cache: nil, ignore_directories: nil, readonly: nil, revalidation: nil, compile_cache_iseq: nil, compile_cache_yaml: nil, compile_cache_json: nil, config_path: nil); end
...
module Bootsnap::LoadPathCache::Native
  def self.scan_dir(arg0); end
end
module Bootsnap::CompileCache::Native
  def compile_option_crc32=(arg0); end
  def fetch(arg0, arg1, arg2, arg3, arg4); end
  def precompile(arg0, arg1, arg2, arg3); end
  def readonly=(arg0); end
  def revalidation=(arg0); end
  def self.compile_option_crc32=(arg0); end
  def self.fetch(arg0, arg1, arg2, arg3, arg4); end
  def self.precompile(arg0, arg1, arg2, arg3); end
...
module Bootsnap::LoadPathCache::PathScanner
  def self.call(root_path); end
  def self.ignored_directories; end
  def self.ignored_directories=(arg0); end
  def self.native_call(root_path); end
  def self.prepare_scan(root_path); end
  def self.ruby_call(root_path); end
  def self.walk(absolute_dir_path, relative_dir_path, ignored_abs_paths, ignored_dir_names, &block); end
end
...
module Bootsnap::CompileCache::ISeq
  ...
  def self.compiler_selector; end
  def self.compiler_selector=(arg0); end
  def self.coverage_on?; end
  def self.default_compiler; end
  def self.default_compiler=(arg0); end
...
class Bootsnap::CompileCache::ISeq::Compiler
  def initialize(namespace = nil, compile_options = nil); end
...
module InvalidName___Class_0x00___EncodingAwareSymbols_15
  def unpack(payload); end
  extend InvalidName___Class_0x00___EncodingAwareSymbols_15
end

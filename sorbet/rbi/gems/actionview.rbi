...
module ActionView
  ...
  def self.render_tracker; end
  def self.render_tracker=(arg0); end
...
module ActionView::Helpers::UrlHelper
  ...
  def current_page?(options = nil, check_parameters: nil, method: nil, **options_as_kwargs); end
...
module ActionView::Helpers::AssetTagHelper
  ...
  def self.auto_include_nonce_for_scripts; end
  def self.auto_include_nonce_for_scripts=(val); end
  def self.auto_include_nonce_for_styles; end
  def self.auto_include_nonce_for_styles=(val); end
...
module ActionView::Helpers::DateHelper
  ...
  def relative_time_in_words(from_time, options = nil); end
...
module ActionView::Helpers::JavaScriptHelper
  ...
  def self.auto_include_nonce; end
  def self.auto_include_nonce=(val); end
end
...
class ActionView::Base
  ...
  def self.prefix_partial_path_with_controller_namespace?; end
  def self.remove_hidden_field_autocomplete; end
  def self.remove_hidden_field_autocomplete=(val); end
...
class ActionView::DependencyTracker::RubyTracker
  ...
  def initialize(name, template, view_paths = nil, parser_class: nil); end
  def name; end

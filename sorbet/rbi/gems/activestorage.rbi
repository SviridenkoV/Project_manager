...
module ActiveStorage
  ...
  def self.checksum_implementation; end
  def self.checksum_implementation=(arg0); end
  ...
  def self.streaming_chunk_max_size; end
  def self.streaming_chunk_max_size=(val); end
  def self.streaming_max_ranges; end
  def self.streaming_max_ranges=(arg0); end
  ...
  def self.variant_transformer; end
  def self.variant_transformer=(val); end
...
class ActiveStorage::InvalidKeyError < ActiveStorage::Error
end
...
class ActiveStorage::Blobs::ProxyController < ActiveStorage::BaseController
  ...
  def self.__class_attr_helpers_path; end
  def self.__class_attr_helpers_path=(new_value); end
  def self.__class_attr_live_streaming_excluded_keys; end
  def self.__class_attr_live_streaming_excluded_keys=(new_value); end
  def self.__class_attr_middleware_stack; end
  def self.__class_attr_middleware_stack=(new_value); end
  def self.live_streaming_excluded_keys; end
  def self.live_streaming_excluded_keys=(value); end
  def self.live_streaming_excluded_keys?; end
  def show; end
...
class ActiveStorage::Blob < ActiveStorage::Record
  ...
  def self.filter_metadata(metadata); end

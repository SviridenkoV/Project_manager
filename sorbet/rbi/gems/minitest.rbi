...
module Minitest
  ...
  def self.run_all_suites(reporter, options); end
  def self.seed; end
...
module Minitest::Assertions
  ...
  def refute_includes(obj, sub, msg = nil); end
...
class Minitest::Runnable
  ...
  def result_code; end
  def run; end
  def self.filter_runnable_methods(options = nil); end
  def self.inherited(klass); end
  def self.methods_matching(re); end
  def self.on_signal(name, action); end
  def self.reset; end
  def self.run(klass, method_name, reporter); end
  def self.run_order; end
  def self.run_suite(reporter, options = nil); end
  def self.runnable_methods; end
  def self.runnables; end
  def self.with_info_handler(_reporter = nil, &block); end
  def skipped?; end
  def time; end
  def time=(arg0); end
  def time_it; end

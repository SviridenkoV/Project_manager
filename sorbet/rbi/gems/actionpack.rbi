...
module ActionDispatch
  ...
  def self.verbose_redirect_logs; end
  def self.verbose_redirect_logs=(arg0); end
  def test_app; end
...
class ActionController::TooManyRequests < ActionController::ActionControllerError
end
...
class ActionDispatch::Journey::Route
  ...
  def glob?; end
  def initialize(name:, path:, app: nil, constraints: nil, required_defaults: nil, defaults: nil, via: nil, precedence: nil, scope_options: nil, internal: nil, source_location: nil); end
  def internal; end
  def ip; end
...
class ActionDispatch::Routing::Mapper::Mapping
  ...
  def scope_options; end
  def self.build(scope, set, ast, controller, default_action, to, via, formatted, options_constraints, anchor, internal, options); end
...
module ActionDispatch::Routing::Mapper::Base
  ...
  def mount(app = nil, deprecated_options = nil, as: nil, via: nil, at: nil, defaults: nil, constraints: nil, anchor: nil, format: nil, path: nil, internal: nil, **mapping, &block); end
  def rails_app?(app); end
  def with_default_scope(scope, &block); end
end
module ActionDispatch::Routing::Mapper::HttpHelpers
  def connect(*path_or_actions, as: nil, to: nil, controller: nil, action: nil, on: nil, defaults: nil, constraints: nil, anchor: nil, format: nil, path: nil, internal: nil, **mapping, &block); end
  def delete(*path_or_actions, as: nil, to: nil, controller: nil, action: nil, on: nil, defaults: nil, constraints: nil, anchor: nil, format: nil, path: nil, internal: nil, **mapping, &block); end
  def get(*path_or_actions, as: nil, to: nil, controller: nil, action: nil, on: nil, defaults: nil, constraints: nil, anchor: nil, format: nil, path: nil, internal: nil, **mapping, &block); end
  def options(*path_or_actions, as: nil, to: nil, controller: nil, action: nil, on: nil, defaults: nil, constraints: nil, anchor: nil, format: nil, path: nil, internal: nil, **mapping, &block); end
  def patch(*path_or_actions, as: nil, to: nil, controller: nil, action: nil, on: nil, defaults: nil, constraints: nil, anchor: nil, format: nil, path: nil, internal: nil, **mapping, &block); end
  def post(*path_or_actions, as: nil, to: nil, controller: nil, action: nil, on: nil, defaults: nil, constraints: nil, anchor: nil, format: nil, path: nil, internal: nil, **mapping, &block); end
  def put(*path_or_actions, as: nil, to: nil, controller: nil, action: nil, on: nil, defaults: nil, constraints: nil, anchor: nil, format: nil, path: nil, internal: nil, **mapping, &block); end
end
module ActionDispatch::Routing::Mapper::Scoping
  ...
  def namespace(name, deprecated_options = nil, as: nil, path: nil, shallow_path: nil, shallow_prefix: nil, **options, &block); end
  def scope(*args, only: nil, except: nil, **options); end
end
module ActionDispatch::Routing::Mapper::Resources
  ...
  def apply_common_behavior_for(method, resources, shallow: nil, **options, &block); end
  def canonical_action?(action); end
  def collection(&block); end
  def decomposed_match(path, controller, as, action, _path, to, via, formatted, anchor, options_constraints, internal, options_mapping, on = nil); end
  def draw(name); end
  def get_to_from_path(path, to, action); end
  def map_match(path_or_action, constraints: nil, anchor: nil, format: nil, path: nil, as: nil, via: nil, to: nil, controller: nil, action: nil, on: nil, internal: nil, mapping: nil); end
  def match(*path_or_actions, as: nil, via: nil, to: nil, controller: nil, action: nil, on: nil, defaults: nil, constraints: nil, anchor: nil, format: nil, path: nil, internal: nil, **mapping, &block); end
  ...
  def resource(*resources, concerns: nil, **options, &block); end
  def resource_method_scope?; end
  def resource_scope(resource, &block); end
  def resource_scope?; end
  def resources(*resources, concerns: nil, **options, &block); end
...
class ActionDispatch::Routing::Mapper::Resources::Resource
  ...
  def initialize(entities, api_only, shallow, only: nil, except: nil, **options); end
...
module ActionDispatch::Http::URL
  ...
  def self.domain_extractor; end
  def self.domain_extractor=(val); end
...
module ActionController::Live
  ...
  def self.live_streaming_excluded_keys; end
  def self.live_streaming_excluded_keys=(val); end
...
module ActionController::RateLimiting::ClassMethods
  def rate_limit(to:, within:, by: nil, with: nil, store: nil, name: nil, scope: nil, **options); end
end
...
class ActionController::Base < ActionController::Metal
  ...
  def mimes_for_respond_to=(arg0); end
  def mimes_for_respond_to?; end
  def notice; end
  ...
  def self.__class_attr___callbacks; end
  def self.__class_attr___callbacks=(new_value); end
  def self.__class_attr__allowed_redirect_hosts; end
  def self.__class_attr__allowed_redirect_hosts=(new_value); end
  ...
  def self.__class_attr_allowed_redirect_hosts_permissions; end
  def self.__class_attr_allowed_redirect_hosts_permissions=(new_value); end
  def self.__class_attr_config; end
  def self.__class_attr_config=(new_value); end
  def self.__class_attr_default_url_options; end
  def self.__class_attr_default_url_options=(new_value); end
  def self.__class_attr_escape_json_responses; end
  def self.__class_attr_escape_json_responses=(new_value); end
  ...
  def self.__class_attr_middleware_stack; end
  def self.__class_attr_middleware_stack=(new_value); end
  def self.__class_attr_mimes_for_respond_to; end
  def self.__class_attr_mimes_for_respond_to=(new_value); end
  def self.__class_attr_rescue_handlers; end
  def self.__class_attr_rescue_handlers=(new_value); end
  def self.__class_attr_responder; end
  def self.__class_attr_responder=(new_value); end
  def self._allowed_redirect_hosts; end
  def self._allowed_redirect_hosts=(value); end
  ...
  def self._wrapper_options?; end
  def self.action_on_open_redirect; end
  def self.action_on_open_redirect=(val); end
  def self.action_on_path_relative_redirect; end
  def self.action_on_path_relative_redirect=(val); end
  def self.allow_forgery_protection(*, **, &); end
  def self.allow_forgery_protection=(arg); end
  def self.allowed_redirect_hosts; end
  def self.allowed_redirect_hosts_permissions; end
  def self.allowed_redirect_hosts_permissions=(value); end
  def self.asset_host(*, **, &); end
  def self.asset_host=(arg); end
  def self.assets_dir(*, **, &); end
  def self.assets_dir=(arg); end
  def self.csrf_token_storage_strategy(*, **, &); end
  def self.csrf_token_storage_strategy=(arg); end
  def self.default_asset_host_protocol(*, **, &); end
  def self.default_asset_host_protocol=(arg); end
  def self.default_static_extension(*, **, &); end
  def self.default_static_extension=(arg); end
  def self.default_url_options; end
  def self.default_url_options=(value); end
  def self.default_url_options?; end
  def self.enable_fragment_cache_logging(*, **, &); end
  def self.enable_fragment_cache_logging=(arg); end
  def self.escape_json_responses; end
  def self.escape_json_responses=(value); end
  def self.escape_json_responses?; end
  ...
  def self.forgery_protection_origin_check=(arg); end
  def self.forgery_protection_strategy(*, **, &); end
  def self.forgery_protection_strategy=(arg); end
  ...
  def self.javascripts_dir=(arg); end
  def self.log_warning_on_csrf_failure(*, **, &); end
  def self.log_warning_on_csrf_failure=(arg); end
  def self.logger(*, **, &); end
  def self.logger=(arg); end
  def self.mimes_for_respond_to; end
  def self.mimes_for_respond_to=(value); end
  def self.mimes_for_respond_to?; end
  def self.per_form_csrf_tokens(*, **, &); end
  def self.per_form_csrf_tokens=(arg); end
  def self.perform_caching(*, **, &); end
  def self.perform_caching=(arg); end
  ...
  def self.relative_url_root=(arg); end
  def self.request_forgery_protection_token(*, **, &); end
  def self.request_forgery_protection_token=(arg); end
  ...
  def self.stylesheets_dir=(arg); end
